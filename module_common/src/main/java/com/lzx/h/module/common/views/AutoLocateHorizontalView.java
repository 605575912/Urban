        ...
        getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                if (isInit) {
                    ...
                    linearLayoutManager.scrollToPositionWithOffset(0, -initPos * (itemWidth));
                    isInit = false;
                }
            }
        });
...
//            deltaX -= itemWidth * (selectPos - adapter.getItemCount() + 1);
//        }
...
//            }
            ...
            //超出上个item的位置
            int overLastPosOffset = deltaX % itemWidth - itemWidth / 2;
            LogUtil.i(deltaX + "==" + itemWidth + "==" + overLastPosOffset);
            ...
            adapter.notifyItemChanged(oldSelectedPos + 1);
            adapter.notifyItemChanged(selectPos + 1);
